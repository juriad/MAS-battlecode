...
public class Miner extends BaseBot {
    ...
    protected Direction towardsOre() throws GameActionException {
        ...
        MapLocation[] locations = MapLocation.getAllMapLocationsWithinRadiusSq(rc.getLocation(), 4);
        ...
        MapLocation mapLocation2 = mapLocation.add(Direction.values()[((int) (Math.random() * 100)) % 8]);
